            ...
            function(t, e, r) {
                ...
                if (!c) {
                    if (!(f = "auto" === p.grid ? 0 : (p.grid || [1, U])[1])) {
                        for (
                            h = -U; h < (h = r[f++].getBoundingClientRect().left) && f < d;
                    ...
                    if (
                        (this._hasPause &&
                            ...
                            ((this._onUpdate = this.vars.onUpdate),
                                (this._initted = 1),
                                (this._zTime = t),
                                (_ = 0)), !_ && i && !e && !s && (Ct(this, "onStart"), this._tTime !== v))
                    )
                        return this;
                    if (_ <= i && 0 <= t)
                        for (n = this._first; n;) {
        ...
        if (
            ...
            (u = new pt[t]()).init(
                ...
                (function _processVars(t, e, i, n, a) {
                    if (
                        (s(t) && (t = Kt(t, a, e, i, n)), !v(t) || (t.style && t.nodeType) || Z(t) || $(t))
                    )
            ...
            if (
                (r(n) &&
                    (~n.indexOf("random(") && (n = ob(n)),
                        "=" === n.charAt(1) &&
                        ((!(d = ka(p, n) + (Ya(p) || 0)) && 0 !== d) || (n = d))), !f || p !== n || Gt)
            )
                return isNaN(p * n) || "" === n ?
                    (c || e in t || Q(e, n),
        ...
        Qt = function _initTween(t, e, r) {
            ...
            if (
                (!D || (k && g) || (g = "none"),
                    ...
                    (t._from = !D && !!m.runBackwards), !D || (k && !m.stagger))
            ) {
                if (
                ...
                for (
                    t._pt = t._ptCache = 0, T = (P && w(T)) || (T && !P), n = 0; n < A.length; n++
                ) {
                    if (
        ...
        function Tween(e, r, i, n) {
            ...
            if (
                ((a._targets = C.length ?
                        ea(C) :
                        R(
                            "GSAP target " + e + " not found. https://gsap.com", !q.nullTargetWarn
                        ) || []),
                    (a._ptLookup = []),
                    (a._overwrite = b),
                    x || T || y(_) || y(m))
                ...
                if (
                    ...
                    for (o = 0; o < h; o++)
                        ...
                        (u.delay =
                            (+Kt(m, _assertThisInitialized(a), o, f, C) || 0) - a._delay), !T &&
                        1 === h &&
                        u.delay &&
                    ...
                    if (
                        ...
                        this._onUpdate &&
                            ...
                            (_ && !this._onUpdate && Ca(this, t, 0, !0),
                                ...
                                (_ && !d) ||
                                !(m || d || u) ||
                                (Ct(this, m === c ? "onComplete" : "onReverseComplete", !0), !this._prom ||
            ...
            (e.resetTo = function resetTo(t, e, r, i, n) {
                ...
                return (
                    ...
                    (function _updatePropTweens(t, e, r, i, n, a, s, o) {
                        ...
                        if (!d)
                            for (
                                d = t._ptCache[e] = [], l = t._ptLookup, f = t._targets.length; f--;
